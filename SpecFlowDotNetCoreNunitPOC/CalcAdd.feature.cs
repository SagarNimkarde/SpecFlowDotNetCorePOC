...
namespace SpecFlowDotNetCoreNunitPOC
{
    ...
    [NUnit.Framework.DescriptionAttribute("CalcAdd")]
    public partial class CalcAddFeature
    {
...
#line 8
 testRunner.Given(string.Format("I have entered {0} into the calculator Nunit", a), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line 9
 testRunner.And(string.Format("I have also entered {0} into the calculator Nunit", b), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 10
 testRunner.When("I press add Nunit", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 11
 testRunner.Then(string.Format("the result should be {0} on the screen Nunit", c), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
